...
describe('EnergyProvision Value Object', () => {
  describe('Constructor & Validation', () => {
    it('should create a valid basic energy provision', () => {
      const provision = new EnergyProvision([EnergyType.FIRE], 1, false);
    ...
    it('should create a valid special energy provision', () => {
      const provision = new EnergyProvision([EnergyType.COLORLESS], 2, true, [
    ...
    it('should require isSpecial=true when restrictions present', () => {
      expect(() => {
        new EnergyProvision([EnergyType.GRASS], 1, false, ['Some restriction']);
      }).toThrow(
        'Energy cards with multiple energy, restrictions, or effects must be marked as special',
      );
    });
  ...
  describe('Helper Methods', () => {
    describe('isBasicEnergy', () => {
      ...
      it('should return false if has restrictions', () => {
        const provision = new EnergyProvision([EnergyType.GRASS], 1, true, [
          'Restriction',
        ]);
    ...
    describe('providesType', () => {
      it('should return true if provides the specified type', () => {
        const provision = new EnergyProvision([EnergyType.FIGHTING], 1, false);
    ...
    describe('hasAdditionalEffects', () => {
      ...
      it('should return false if no additional effects', () => {
        const provision = new EnergyProvision([EnergyType.WATER], 1, false);
    ...
    describe('getDescription', () => {
      it('should generate description for basic energy', () => {
        const provision = new EnergyProvision([EnergyType.GRASS], 1, false);
      ...
      it('should include restrictions in description', () => {
        ...
        expect(provision.getDescription()).toContain(
          "Restrictions: Can't be used for Pokémon Powers",
        );
      });
    ...
    describe('equals', () => {
      it('should return true for identical provisions', () => {
        const provision1 = new EnergyProvision([EnergyType.FIRE], 1, false);
        const provision2 = new EnergyProvision([EnergyType.FIRE], 1, false);
      ...
      it('should return false for different energy types', () => {
        const provision1 = new EnergyProvision([EnergyType.FIRE], 1, false);
        const provision2 = new EnergyProvision([EnergyType.WATER], 1, false);

        expect(provision1.equals(provision2)).toBe(false);
      });

      it('should return false for different amounts', () => {
        const provision1 = new EnergyProvision([EnergyType.COLORLESS], 1, true);
        const provision2 = new EnergyProvision([EnergyType.COLORLESS], 2, true);
